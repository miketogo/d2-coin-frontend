    ...
    <footer className="footer">
      ...
      <div className="footer__row footer__row-second">
        <nav className="footer__nav">
          {props.links.map((item, i) => (
            <NavLink exact to={item.link} className="footer__nav-link" activeClassName="footer__nav-link_active" key={`footer__nav-link${i}`}>{item.text}</NavLink>
      ...
      {/* <div className="footer__row footer__row-third">
        <div className="footer__docs">
          <a className="footer__doc-link" target="_blank" rel="noreferrer" href="/#">Privacy Policy</a>
