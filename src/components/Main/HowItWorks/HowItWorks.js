...
import trg from '../../../assets/images/how-it-works/trg.png'
      ...
      <div className="how-it-works__stages">
        {stages.map((item, i) => (
          <div className="how-it-works__stage" key={`how-it-works__stage${i}`}>
            <div className="how-it-works__stage-images">
              <img className="how-it-works__stage-img" src={item.img} alt={`stage ${i + 1}`} />
              <img className="how-it-works__stage-img-bg" src={trg} alt={`stage ${i + 1}`} />
            </div>

            <div className="how-it-works__stage-texts">
