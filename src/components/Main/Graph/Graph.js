...
import bg from '../../../assets/images/graph/bg.png'
...
function Graph() {
  ...
  return (
    <section className="graph">
      <h2 className="graph__title">DCR creates liquidity for the diamond market in a form of a stable coin</h2>
      <p className="graph__subtitle">Diamond market share of lab-grown diamonds worldwide from 2016 to 2021</p>
      <div className="graph__histogram-card">
      <img className="graph__histogram-bg" src={bg} alt='card' />
